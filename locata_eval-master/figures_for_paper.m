...
% Script to create figures with LOCATA results
%
% INPUT: 
% results_dir : directory name where the mat-file 'averaged_measures_<results_date>.mat' 
%               is located (e.g., './results')
% results_date: time stamp (e.g., '2020-09-03_182325')
%
% OUTPUT:
% none 
% (figures are saved in the directory with the results in the subfolder
%  'stats')
%
%
...
flag_final = 1;
flag_title = 0; % if 1, title for each figure is plotted
flag_save = 1;  % if 1, figures are saved

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if ~exist( [results_dir, filesep, 'averaged_measures_', results_date, '.mat'], 'file')
    error('Mat-file with results not found. Check the provided directory name and time stamp') 
else
