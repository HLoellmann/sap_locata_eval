...
%
% Notice: This is part of the LOCATA development release. Please report
%         problems and bugs to the author.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
opts.valid_sources = {'hendrik', 'christine', 'alex', 'heinrich', 'claas', 'loudspeaker1', 'loudspeaker2', 'loudspeaker3', 'loudspeaker4'};
